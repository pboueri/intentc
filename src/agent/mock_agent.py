"""Mock agent for testing (standalone copy)."""
...
class MockAgent(Agent):
    ...
    def __init__(
        ...
        self.build_response = build_response or BuildResponse(status="success", summary="Mock build completed")
        self.validation_response = validation_response or ValidationResponse(name="mock-validation", status="pass", reason="Mock validation passed")
        self.differencing_response = differencing_response or DifferencingResponse(status="equivalent", summary="Mock differencing completed")
